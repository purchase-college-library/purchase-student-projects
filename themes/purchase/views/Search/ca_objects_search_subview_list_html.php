...
<?php
		...
		while($qr_results->nextHit()) {
				...
				print "
	<div class='bResultListItemCol col-xs-12 col-sm-4'>
		<div class='bResultListItem'>
			<div class='bResultListItemContent'><div class='bResultItemImgContainer' >
				<div class='bResultListItemImg' >
					<span style='position:relative;display:inline-block;'>{$vs_add_to_set_link}{$vs_rep_detail_link}</span>
			</div></div>
			<div class='bResultItemText'>
				<p>".caDetailLink($this->request, $vs_link_text, '', 'ca_objects', $vn_id)."</p>".$vs_student.$vs_major."
				<p>".$vs_download_link."</p>
			</div>
			</div>
