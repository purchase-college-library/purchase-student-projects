...
?>
		...
		<H1><?php print _t("Contact the Digital Collections Center"); print $who_label; ?></H1>
...
?>
		...
		<div id="shareForm">
			<div><?php print _t("Use this form below to contact the DCC staff for more information or with questions."); ?></div>
			<form method="post" action="<?php print caNavUrl($this->request, 'Contact', 'Contact', 'sendEmailObject', array('object_id' => $vn_object_id)); ?>" name="emailObject" enctype='multipart/form-data'>
				<div class="formLabel">
					...
					<input type="hidden" name="to_email" value="eric@openflows.com">
				</div>
				<div class="formLabel">
...
?>
				<div class="formLabel">
					...
					<input type="hidden" name="subject" value="contact us form entry">
				</div>
				<div class="formLabel">
