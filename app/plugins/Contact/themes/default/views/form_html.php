...
?>
		...
		<div id="shareForm">
			...
			<form method="post" action="<?php print caNavUrl($this->request, 'Contact', 'Contact', 'sendEmail', array('item_id' => $vn_item_id, 'tablename' => $vs_tablename)); ?>" name="emailForm" enctype='multipart/form-data'>
				<div class="formLabel">
