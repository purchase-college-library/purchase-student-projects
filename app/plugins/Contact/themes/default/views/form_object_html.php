...
?>
		...
		<H1><?php print _t("Contact the Library Staff"); print $who_label; ?></H1>
...
?>
		...
		<div id="shareForm">
			<div><?php print _t("Use the form below to contact the staff for more information or with a research request"); ?></div>
